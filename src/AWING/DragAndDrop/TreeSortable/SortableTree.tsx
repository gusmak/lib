...
import type { FlattenedItem, ItemChangedReason, SensorContext, TreeItemComponentType, TreeItems } from './types';
...
export function SortableTree<TreeItemData extends Record<string, any>, TElement extends HTMLElement = HTMLDivElement>({
    ...
    const flattenedItems = useMemo(() => {
        ...
        //     const p = result.filter((i) => i.parentId === null);

        //     p.map((i) => {
        //         const items = result.filter((i) => i.parentId === i.id);
        //         if (items.length) {
        //             i.children = items;
        //         }
        //     });
    ...
    // useLayoutEffect(() => {
    // const psd = flattenedItems.filter((o) => o.parent !== null);
    // }, []);
                ...
                {flattenedItems.map((item) => {
                    return (
                        <SortableTreeItem
                            ...
                            depth={
                                item.id === activeId && projected && !keepGhostInPlace ? projected.depth : item.depth
                            }
                            ...
                            disableSorting={disableSorting !== undefined ? disableSorting : item.disableSorting}
