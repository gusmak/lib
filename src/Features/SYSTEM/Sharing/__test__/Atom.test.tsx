...
import { confirmExitState, resetAllWorkspaceSharingState } from '../Atoms';

describe('Recoil Selectors', () => {
    describe('resetStateReconciliation', () => {
        it('should get undefined', () => {
            const { result } = renderHook(() => useAtomValue(resetAllWorkspaceSharingState), {
        ...
        it('should reset all states', () => {
            const { result } = renderHook(
                () => {
                    const resetAllWorkspaceSharing = useSetAtom(resetAllWorkspaceSharingState);
