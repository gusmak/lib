...
describe('render', () => {
    ...
    it('should is Create', () => {
        ...
        expect(screen.getByTestId('drawer-title')).toHaveTextContent('Role.Create');
    });
    ...
    it('should is Edit', () => {
        ...
        expect(screen.getByTestId('drawer-title')).toHaveTextContent('Role.Edit');
    });
    ...
    it('should call onCompleted', async () => {
        ...
        await waitFor(() => {
            expect(screen.queryByTestId('roleTag-2')).toBeInTheDocument();
        });
    });
});
